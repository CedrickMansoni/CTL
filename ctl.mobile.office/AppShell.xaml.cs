...
public partial class AppShell : Shell
{
	...
	void RegisterRoutes()
	{
		...
		Routing.RegisterRoute(nameof(NoticiaEdite_OfficePage), typeof(NoticiaEdite_OfficePage));
		Routing.RegisterRoute(nameof(Campo_OfficePageEdite), typeof(Campo_OfficePageEdite));
		Routing.RegisterRoute(nameof(Banco_OfficePageEdite), typeof(Banco_OfficePageEdite));
	}
}
